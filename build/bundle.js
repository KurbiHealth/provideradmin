...
module.exports = function (nga, chatroom) {
    ...
    // LIST VIEW
    chatroom.listView().fields([nga.field('dt_create', 'datetime').label('Created'), nga.field('messages', 'obj_key_value_field').label('').keyValueChoices('{"qCode":"back pain details"}')]).listActions(['show']);
